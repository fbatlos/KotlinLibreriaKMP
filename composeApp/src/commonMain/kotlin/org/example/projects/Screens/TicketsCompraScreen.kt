...
fun TicketCard(compra: Compra) {
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            Text("Usuario: ${compra.usuarioName}", color = AppColors.primary, style = MaterialTheme.typography.h6)
            Text("Fecha: ${compra.fechaCompra}", color = AppColors.grey, style = MaterialTheme.typography.body2)
