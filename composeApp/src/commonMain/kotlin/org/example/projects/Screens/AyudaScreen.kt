...
fun AyudaScreen(
    ...
    val showMandarTicket by ticketViewModel.showTicket.collectAsState()
    ...
    LayoutPrincipal(
        ...
        if (isLoading){
            ...
            LazyColumn(
                ...
                item {
                    Divider(color = AppColors.primary, thickness = 2.dp)
                    Spacer(modifier = Modifier.height(32.dp))
                    Text(
                    ...
                    if (showMandarTicket) {
                        ...
                        OutlinedTextField(
                            ...
                            label = { Text("Cuerpo del mensaje",color = AppColors.primary) },
                            modifier = Modifier
                                .fillMaxWidth()
                                .height(150.dp)
                        ...
                        Button(
                            ...
                            enabled = titulo.isNotEmpty() && cuerpo.isNotEmpty(),
                            contentPadding = PaddingValues(horizontal = 12.dp, vertical = 4.dp)
                        ) {
                            Text("Enviar Ticket")
                        }
                    }else{
                        Text("Ya has enviado un ticket.", style = MaterialTheme.typography.h6, color = AppColors.primary)
                    }
                    Spacer(modifier = Modifier.height(12.dp))
                }
